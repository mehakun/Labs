                                  ...
                                  GLfloat materialShininess)
{
    ...
    program->setUniformValue("light.intensities", light.intensities);

    // set ambient coeff
    program->setUniformValue("light.ambientCoefficient", light.ambientCoeff);

    // set attenuation
    program->setUniformValue("light.attenuation", light.attenuation);

    // set material attributes
    program->setUniformValue("materialSpecularColor", materialSpecularColor);
    program->setUniformValue("materialShininess", materialShininess);
